/**
 * 정보형 콘텐츠 공통 컴포넌트
 * 상세 글 · 허브 · 정책 · 체크리스트 템플릿에서 재사용
 *
 * 사용:
 *   import { KeyPointsBox, FAQSection, ... } from '@/components/content';
 */

export { default as TargetUserBox }        from './TargetUserBox';
export { default as ReviewStatusBox }      from './ReviewStatusBox';
export { default as KeyPointsBox }         from './KeyPointsBox';
